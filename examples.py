...
print("EXAMPLES")
print(sim_str_str("Odio los aviones","No me gustan los helicópteros",lang1="es",lang2="es",stat="max"))
print(sim_str_str("Computer science","Repair my printer",lang1="en",lang2="en",stat="max"))
print(sim_str_str("支持四种分词模式","支持四种分词模式",lang1="zh",lang2="zh",stat="max"))
print(sim_str_attrlst_multiling("Estoy probando esta nueva aplicación en mi portátil conectado a internet.",[("profesión","programador aplicaciones"),("afición","escalada")],stat="max"))
print(sim_str_attrlst_multiling("Estoy probando esta nueva aplicación en mi portátil conectado a internet.",[("job","applications programmer"),("hobby","climbing")],stat="max"))
